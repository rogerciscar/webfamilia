    ...
    menus: [
      {
        ...
        variants: [
          {
            name: "General",
            salads: { A1: "Amanida verda", A2: "Amanida de pasta" },
            days: [
              {
                date: "2026-09-10",
                dayOfMonth: 10,
                weekday: "DIJOUS",
                courses: ["Macarrons 10/09", "Peix arrebossat"],
                saladCode: "A1",
                dessert: "Iogurt",
                nutrition: { kcal: 700 },
              },
              {
                ...
                dayOfMonth: 17,
                weekday: "DIJOUS",
                courses: ["Arròs integral 17/09", "Pollastre al forn"],
                saladCode: "A2",
                dessert: "Poma",
                nutrition: { kcal: 720 },
              },
              {
                ...
                dayOfMonth: 18,
                weekday: "DIVENDRES",
                courses: ["Sopa de verdura", "Truita"],
                saladCode: "A1",
                dessert: "Fruita",
                nutrition: { kcal: 680 },
              },
          ...
          {
            name: "Menú complementari nits",
            days: [
              {
                date: "2026-09-10",
                dayOfMonth: 10,
                weekday: "DIJOUS",
                courses: ["Sopar 10/09 · Brou"],
                dessert: "Llet",
              },
              {
                date: "2026-09-17",
